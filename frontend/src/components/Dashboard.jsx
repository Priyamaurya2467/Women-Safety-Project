...
import { Accessibility, Check,Info,AlertTriangle ,ArrowBigRight, ArrowBigRightDash, ArrowRightSquare, ArrowRightToLine, CarTaxiFront, ChevronRight, PersonStanding, Search, WandSparkles, WineOff } from 'lucide-react'
  ...
  return (
    ...
    <div className='flex min-h-screen '>
        ...
        <main className='flex-1 p-3 bg-gray-100'>
          ...
          <h1 className='text-2xl pt-5 font-semibold'>Welcome back, Jane</h1>
          <p className='text-xs text-gray-400 p-1 font-stretch-expanded'>Your safety is our priority.</p>
